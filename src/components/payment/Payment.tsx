  ...
  return (
    <div className="mt-[30px] border-[1px] border-[#D6D8EE] rounded-[32px] p-[30px] bg-[#FFFFFF]">
      ...
      <div className="flex mt-[20px]">
        <div className="bg-[#5A31F499] py-[15px] px-[31px] rounded-[16px] mr-5 w-[147px] flex justify-center border-[1px] border-[#5A31F4] ">
          <img alt="shop" src={Shop} />
        </div>
        <div className="bg-[] py-[15px] px-[31px] rounded-[16px] mr-5 w-[147px] flex justify-center border-[1px] border-[#113984] ">
